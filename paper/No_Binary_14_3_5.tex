...
Lemma~\ref{lem:ten-site} then forces a ten-site additive code of size 1,024, distance at least five, and hull dimension four. By Lemma~\ref{lem:additive-lift}, none of the 37 equivalence classes of such codes supplies one: 25 fail on hull dimension and the remaining 12 on the coset-capacity bound. This is a contradiction.
\end{proof}
