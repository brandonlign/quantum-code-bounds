...
reconstruct all 37 such equivalence classes by exhaustive
lengthening: 25 have hull dimension different from four, and the
remaining 12 violate the necessary coset-capacity bound. Together with the known
